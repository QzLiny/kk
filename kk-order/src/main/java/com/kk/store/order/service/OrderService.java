package com.kk.store.order.service;
...
//    private RabbitTemplate rabbitTemplate;
    ...
    public KkResult createOrder(String json) {
        Order order = null;
        try {
            ...
            return KkResult.build(400, "请求参数有误!");
        }
...
//            this.rabbitTemplate.convertAndSend(objectMapper.writeValueAsString(msg));
            ...
            return KkResult.ok(orderId);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return KkResult.build(400, "保存订单失败!");
    }
