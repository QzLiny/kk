...
<head>
    ...
    <title>登录淘淘</title>
    <link type="text/css" rel="stylesheet" href="http://static.kk.com/css/login.css"/>
    <script type="text/javascript" src="http://static.kk.com/js/jquery-1.2.6.min.js"></script>
    <script type="text/javascript" src="http://static.kk.com/js/login/g.base.js"></script>
   	<script type="text/javascript" src="http://static.kk.com/js/login/jdEdit.js"></script>
...
<div class="w">
    <div id="logo">
    	<a href="http://www.kk.com/" clstag="passport|keycount|login|01">
    		<img src="http://static.kk.com/images/taotao-logo.gif" alt="淘淘" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
<form id="formlogin" method="post" onsubmit="return false;">
    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02" style="width: 511px; height: 455px; position: absolute; left: -44px; top: -44px; background: url(http://static.kk.com/images/544a11d3Na5a3d566.png) 0px 0px no-repeat;">
			</div>
            <div class="form ">
...
<script type="text/javascript" src="http://static.kk.com/js/login/login.js"></script>
<script type="text/javascript" src="http://static.kk.com/js/login/jdThickBox.js"></script>
<script type="text/javascript" src="http://static.kk.com/js/login/checkClient.js"></script>
<script>
