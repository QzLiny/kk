...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <link rel="stylesheet" href="http://static.kk.com/css/base.css">
   <link href="http://static.kk.com/css/purchase.2012.css?v=201410141639" rel="stylesheet" type="text/css">
...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://www.taotao.com/"><img clstag="clickcart|keycount|xincart|logo" src="http://static.kk.com/images/taotao-logo.gif" title="返回淘淘商城首页" alt="返回淘淘商城首页"></a></div>
          ...
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://www.kk.com/order/create.html" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">去结算<b></b></a>
                  </span>
...
<script type="text/javascript" src="http://static.kk.com/js/base-v1.js"></script>
<!-- footer start -->
<jsp:include page="../commons/footer.jsp" />
<!-- footer end -->

<!-- 购物车相关业务 -->
<script type="text/javascript" src="http://static.kk.com/js/cart.js"></script>
<script type="text/javascript" src="http://static.kk.com/js/jquery.price_format.2.0.min.js"></script>
